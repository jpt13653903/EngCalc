...
void STRING::Append(char16 Data){
 size_t  j;
 char16* Temp;
...
void STRING::Append(char32 Data){
 size_t  j;
 char32* Temp;
...
void STRING::operator= (const char16* String){
 size_t j;
 Invalidate();
...
void STRING::operator= (const char32* String){
 size_t j;
 Invalidate();
...
size_t STRING::Length16(){
 Update16();
 return Length_16;
}
//------------------------------------------------------------------------------

size_t STRING::Length32(){
 return Length_32;
}
//------------------------------------------------------------------------------
...
bool STRING::operator== (const char16* String){
 STRING s2;
 s2 = String;
...
bool STRING::operator== (const char32* String){
 size_t j;
...
int STRING::CompareNoCase(const STRING& String){
 STRING Left, Right;
...
bool operator== (const char16* String1, STRING& String2){
 return String2 == String1;
}
//------------------------------------------------------------------------------

bool operator== (const char32* String1, STRING& String2){
 return String2 == String1;
}
//------------------------------------------------------------------------------
...
void STRING::SetHex(unsigned i, int Places){ // Hexadecimal
 Invalidate();
...
void STRING::AppendHex(unsigned i, int Places){
 Invalidate();
...
void STRING::AppendFloat(double d, int SignificantFigures, bool Fill){
 Invalidate();
