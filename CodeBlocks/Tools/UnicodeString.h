...
class STRING{
 ...
 ~STRING();
  ...
  int CompareNoCase(const STRING& String);
  int CompareNoCase(const char  * String);
};
//------------------------------------------------------------------------------

bool operator== (const char  * String1, STRING& String2); // UTF-8
bool operator== (const char16* String1, STRING& String2); // UTF-16
bool operator== (const char32* String1, STRING& String2); // UTF-32
